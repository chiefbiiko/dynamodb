export { encode, decode } from "https://denopkg.com/chiefbiiko/std-encoding@v1.0.0/mod.ts";
export { get } from "https://denopkg.com/chiefbiiko/get-aws-config@v0.3.2/mod.ts";
